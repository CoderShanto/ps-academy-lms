...
export default factories.createCoreController('api::progress.progress', ({ strapi }) => ({
  async markComplete(ctx) {
    try {
      ...
      // Return success with 200 even if already recorded to prevent UI errors
      return { message: 'Already marked complete', meta: { percentage: 100 } };
    }
  },
