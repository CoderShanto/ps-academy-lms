  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1 mb-6">Platform metrics, per-role distribution, and user permissions</p>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6 border-b border-gray-200 flex justify-between items-center bg-gray-50">
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-lg font-bold text-gray-900">Manage Users & Assign Roles</h2>
          </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-gray-200 text-xs font-bold text-gray-500 uppercase tracking-wider bg-white">
                ...
                <th className="py-4 px-6">Assign New Role</th>
              </tr>
            </thead>
