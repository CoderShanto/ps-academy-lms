  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        try {
          // Populate nested lessons and quizzes
          const { data } = await api.get(`/courses/${id}?populate[lessons][populate]=*&populate=*`);
          fetchedCourse = data.data;
        } catch {
          const { data } = await api.get(`/courses?filters[id][$eq]=${id}&populate[lessons][populate]=*&populate=*`);
