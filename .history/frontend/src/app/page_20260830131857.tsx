...
const ROLES = [
  {
    ...
    perms: ['Manage users', 'Configure roles', 'View analytics'],
  },
  {
    name: 'Instructor',
    color: '#818CF8',
    icon: GraduationCap,
    desc: 'Teach and assess',
    perms: ['Create courses', 'Grade quizzes', 'Track student progress'],
  },
  {
    name: 'Content Manager',
    color: '#EC4899',
    icon: Layers,
    desc: 'Shape the curriculum',
    perms: ['Edit lessons', 'Organize modules', 'Publish content'],
  },
  {
    name: 'Student',
    color: '#34D399',
    ...
    perms: ['Access courses', 'Take quizzes', 'Track progress'],
  },
];

const STEPS = [
  { n: '01', icon: LogIn, title: 'Enroll', desc: "Pick a path suited to your goals." },
  { n: '02', icon: BookOpenCheck, title: 'Learn', desc: 'Work through sequential video and text lessons.' },
  { n: '03', icon: ClipboardCheck, title: 'Assess', desc: 'Submit quizzes graded server-side, instantly.' },
  { n: '04', icon: BarChart3, title: 'Track', desc: 'Watch progress update in real time on your dashboard.' },
];
    ...
    <div className="relative bg-[#05060A]">
      ...
      <section className="relative max-w-7xl mx-auto px-6 py-20 border-t border-white/5">
        <div className="max-w-2xl mb-12">
          <span className="font-mono text-[11px] tracking-wide text-[#22D3EE]">02 · access</span>
          <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-white tracking-tight">
            One platform, four permission sets.
          </h2>
          <p className="mt-4 text-white/50 leading-relaxed">
            Every route checks role on the server before it responds — nothing is
            hidden by the UI alone.
          </p>
        </div>
      ...
      <section className="relative max-w-7xl mx-auto px-6 py-20 border-t border-white/5">
        <div className="max-w-2xl mb-14">
          <span className="font-mono text-[11px] tracking-wide text-[#818CF8]">03 · flow</span>
          <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-white tracking-tight">
      ...
      <section className="relative max-w-7xl mx-auto px-6 py-20 border-t border-white/5">
        <div className="max-w-2xl mb-12">
          <span className="font-mono text-[11px] tracking-wide text-[#EC4899]">04 · why</span>
          <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-white tracking-tight">
