...
const handleCreateArticle = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isAxiosError(err)) {
        // Fallback retry with just title and content in case author or status relations are restricted
        try {
          ...
          if (isAxiosError(retryErr)) {
            setError(retryErr.response?.data?.error?.message || 'Failed to publish article');
          }
        }
      } else {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 h-fit">
          ...
          <form onSubmit={handleCreateArticle} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-800 mb-1">Content / Body</label>
              <textarea
                required
                rows={6}
                value={content}
            ...
            <div>
              ...
              >
                ...
                <option value="published">Published (Public to All)</option>
              </select>
            </div>
                ...
                >
                  <div>
                    ...
                    <p className="text-gray-600 text-sm mt-1 line-clamp-2">
                      {art.content || art.body || 'No content provided.'}
                    </p>
                  </div>
